...
Users can trigger the resume generation process and track its status.
...
**Then** the backend triggers the Probing Question generation process
...
**Then** the system sends the Questions & Answers JSON to the configured n8n webhook
...
**Then** I am taken to a placeholder screen displaying "Relevant Projects"
